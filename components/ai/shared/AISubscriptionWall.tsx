...
const AI_FEATURES = [
  ...
  },
  {
    ...
    description: "Generate tasks and content with natural language"
  },
  {
    icon: ImageIcon,
    title: "Prompt Studio",
    description: "Build and refine assistant prompts with AI guidance"
  },
  {
    icon: Brain,
    title: "Context-Aware",
          ...
          <Card className="relative overflow-hidden rounded-3xl border-2 border-primary/5 bg-card/80 backdrop-blur-xl shadow-2xl">
            ...
            <CardHeader className="relative text-center pb-8 pt-8">
              ...
              <CardDescription className="text-base mt-4 max-w-xs mx-auto">
                Everything you need to supercharge your assistant with AI
              </CardDescription>
            </CardHeader>
