        ...
        <div className="flex flex-col h-full">
          ...
          <ScrollArea className="flex-1 p-3 sm:p-4 overscroll-contain">
            <div className="space-y-3 sm:space-y-6 pb-6 sm:pb-4">
              ...
              {event.project && (
                <div>
                  <h4 className="font-medium text-gray-900 mb-2 text-sm sm:text-base">Assistant</h4>
              ...
              <div className="text-xs text-gray-500 space-y-1">
                ...
                {(event.sourceData as Doc<"tasks">).updatedAt && (
                  <p>Updated: {format(new Date((event.sourceData as Doc<"tasks">).updatedAt!), 'MMM d, yyyy h:mm a')}</p>
                )}
              </div>
            </div>
          </ScrollArea>
