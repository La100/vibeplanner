...
const faqs = [
  {
    ...
    answer:
      "VibePlanner is a layer above your task tracker and docs. We sync with popular tools, ingest updates, and turn them into alignment rituals—without recreating your entire system.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. The Studio plan includes guided setup sessions, and Atlas teams receive a dedicated ritual designer to co-create operating rhythms that match your team.",
  },
];
