...
const summarizeTasksFromSearch = (data: any): string | null => {
  if (!data) return null;
  const total =
...
const summarizeProjectCounts = (data: any): string | null => {
...
const summarizeShoppingSearch = (data: any): string | null => {
  if (!data) return null;
...
const buildFallbackResponseFromTools = (
