...
export const functionTools: FunctionToolDefinition[] = [
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        startDate: { type: "string", description: "Start date in ISO format (YYYY-MM-DDTHH:mm:ss.sssZ). For all-day events, use midnight UTC (T00:00:00.000Z). For specific times, include the time in UTC." },
        endDate: { type: "string", description: "End date in ISO format (YYYY-MM-DDTHH:mm:ss.sssZ). For all-day events, use midnight UTC (T00:00:00.000Z). For specific times, include the time in UTC. Can be same as startDate for single-point events/reminders." },
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        assignedTo: { type: "string", description: "Team member name or email from TEAM MEMBERS list" },
        startDate: { type: "string", description: "New start date in ISO format (YYYY-MM-DDTHH:mm:ss.sssZ). For all-day events, use midnight UTC (T00:00:00.000Z). For specific times, include the time in UTC." },
        endDate: { type: "string", description: "New end date in ISO format (YYYY-MM-DDTHH:mm:ss.sssZ). For all-day events, use midnight UTC (T00:00:00.000Z). For specific times, include the time in UTC. Can be same as startDate for single-point events/reminders." },
